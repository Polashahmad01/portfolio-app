      ...
      <div className="basis-1/2">
        <form onSubmit={onFormSubmitHandler}>
          <div className="flex flex-col mb-4">
            <label
              htmlFor="name"
              className="mb-2 text-xs font-medium text-gray-900 dark:text-white sm:text-base"
            >
              Name
            </label>
            <input
          ...
          <div className="flex flex-col mb-4">
            <label
              htmlFor="email"
              className="mb-2 text-xs font-medium text-gray-900 dark:text-white md:text-base"
            >
              Email
            </label>
            <input
          ...
          <button
            className="bg-gray-50 border py-2 md:py-3 px-4 border-gray-300 text-gray-900 text-xs md:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-pointer hover:text-indigo-600"
            style={{ backgroundColor: "#181818"}}
          >
            Send Message
          </button>
